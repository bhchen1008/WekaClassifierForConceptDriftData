...
public class WekaClassifier_ConceptDriftData {
   ...
   */
  public WekaClassifier_ConceptDriftData() {
    super();
  }
...
//          + m_Filter.getClass().getName() + "\n");
  ...
  public static String usage() {
    return
        "\nusage:\n  " + WekaClassifier_ConceptDriftData.class.getName() 
        + "  <trainingfile>\n"
        + "  <testingfile>\n"
        + "  <Output_Result_Path>\n"
        + "  <CLASSIFIER_name>\n\n"
  ...
  public static void main(String[] args) throws Exception {
    WekaClassifier_ConceptDriftData         demo;

    if (args.length < 4) {
      System.out.println(WekaClassifier_ConceptDriftData.usage());
      System.exit(1);
    }
...
//    			System.out.println("here");
    		...
    		for(int i=1;i<=1;i++){	//取一百筆資料當一個Set
    		...
    		if(matchFound) {
    			...
    			if(matchFound){
    				...
    				filePath = outputPath + "/" + "AccuracySet/"
    						+ fileName + "_threshold_" + (double)threshold/100 + "_All_Accuracy.csv";
